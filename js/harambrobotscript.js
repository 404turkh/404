    ...
    const initUI = () => {
        ...
        const panelHTML = `
            ...
            <div class="harambro-info-panel">
                ...
                <button class="bot-button harambro-stfinish" onclick="window.startBots('stfinish')">▶️ Start</button>
                ...
                <button class="small-button" onclick="window.toggleFixed()">Auto Console OFF</button>
        ...
        if (container) {
            ...
            if (uiRetryCount++ < 10) setTimeout(initUI, 500);
        }
    };
