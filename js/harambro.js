    ...
    const initUI = () => {
        ...
        const panelHTML = `
            ...
            <div class="harambro-info-panel">
                ...
                <button class="bot-button harambro-stfinish" onclick="window.startBots('stfinish')">â¶ï¸ Start</button>
                ...
                <button class="bot-button" onclick="window.toggleSettings()">â</button>
            </div>
        `;
