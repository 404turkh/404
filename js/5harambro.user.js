...
(function() {
    ...
    class Bot {
        constructor(config) {
            ...
            this.name = nameInput ? (nameInput.value.trim() || savedName || "ScarzBots") : (savedName || "ScarzBots");
    ...
    const initUI = () => {
        ...
        const panelHTML = `
            <div class="scarz-title">ScarzBots</div>
